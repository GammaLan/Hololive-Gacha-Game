...
function Eb(a, b, c, d) {
    ...
    if (!f) {
        ...
        for (let k = 0; k < d.length; k++) {
            ...
            e = e || gb(g);
            g = sb(g, b);
            void 0 !== g && (f.push(g), h && hb(g.s))
        }
        h && (hb(f), Object.freeze(f));
        a.i[c] = f;
        ib(d, !e)
    }
    return f
...
function Qb(a) {
    ...
    if (a.constructor === ab) {
        ...
        return {
            buffer: (a.S = b) || Wa || (Wa = new Uint8Array(0)),
            J: !0
        }
    }
...
function gc(a) {
    var b = a.ub;
    if (b) return dc(b);
    if (b = a.Db) return cc(a.Aa.ba, b, a.Cb)
}
...
var qc = pc(function(a, b, c) {
        ...
        if (Ma) {
            ...
            for (; h < d;) {
                var k = a[h++];
                128 > k ? e.push(k) : 224 > k ? h >= d ? Ia(e) : (m = a[h++], 194 > k || 128 !== (m &
                    192) ? (h--, Ia(e)) : e.push((k & 31) << 6 | m & 63)) : 240 > k ? h >= d - 1 ? Ia(e) : (m = a[h++], 128 !== (m & 192) || 224 === k && 160 > m || 237 === k && 160 <= m || 128 !== ((f = a[h++]) & 192) ? (h--, Ia(e)) : e.push((k & 15) << 12 | (m & 63) << 6 | f & 63)) : 244 >= k ? h >= d - 2 ? Ia(e) : (m = a[h++], 128 !== (m & 192) || 0 !== (k << 28) + (m - 144) >> 30 || 128 !== ((f = a[h++]) & 192) || 128 !== ((g = a[h++]) & 192) ? (h--, Ia(e)) : (k = (k & 7) << 18 | (m & 63) << 12 | (f & 63) << 6 | g & 63, k -= 65536, e.push((k >> 10 & 1023) + 55296, (k & 1023) + 56320))) : Ia(e);
...
function wc() {
    ...
    function b(p) {
        ...
        for (n = 0; 80 > n; n++) {
            ...
            I = ((p << 5 | p >>> 27) & 4294967295) + I + Ga + aa + t[n] & 4294967295;
            Ga = G;
            G = z;
...
var N = class extends J {
    ...
    be = [23, 24, 11, 6, 7, 5, 2, 3, 20, 21, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 157, 158, 159, 163, 164, 168, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 198, 199, 200, 201, 203, 204, 205, 206, 258, 259, 260, 261, 209, 226, 227, 232, 233, 234, 240, 247, 248, 251, 254, 255, 270, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 337, 338, 340, 344, 348, 350, 351, 352, 353, 354, 355,
...
const ie = u.window;
let je, ke;
const le = (null == ie ? void 0 : null == (je = ie.yt) ? void 0 : je.config_) || (null == ie ? void 0 : null == (ke = ie.ytcfg) ? void 0 : ke.data_) || {};
w("yt.config_", le);

function O(...a) {
    a = arguments;
    1 < a.length ? le[a[0]] = a[1] : 1 === a.length && Object.assign(le, a[0])
}
...
var se = ["notification/convert_endpoint_to_url"],
    te = ["notification/record_interactions"],
    ue = ["notification_registration/set_registration"];
Date.now();
const ve = [];
...
function Oe() {
    return {
        ...
        Ca: P("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
        Da: P("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
        innertubeContextClientVersion: P("INNERTUBE_CONTEXT_CLIENT_VERSION"),
        ra: P("INNERTUBE_CONTEXT_HL"),
        qa: P("INNERTUBE_CONTEXT_GL"),
        Ea: P("INNERTUBE_HOST_OVERRIDE") || "",
        Ga: !!P("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
        Fa: !!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
            !1),
...
function Se(a, b, c = {}) {
    ...
    (b = c.sb || P("AUTHORIZATION")) || (a ? b = `Bearer ${v("gapi.auth.getToken")().rb}` : b = Ec());
        ...
        e = () => r(function*() {
            ...
            try {
                ...
                if (0 !== l.length) {
                    ...
                    if (a.u < pe("ytidb_reopen_db_retries", 0)) return a.u++, k.close(), bf(new S("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                        dbName: a.name,
                        expectedObjectStores: m,
                        foundObjectStores: p
                    })), e();
                    if (a.o < pe("ytidb_remake_db_retries", 1)) return a.o++, Q("ytidb_remake_db_enable_backoff_delay") && (yield Tf(a.j), a.j *= 2), yield a.delete(), bf(new S("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                        dbName: a.name,
                        expectedObjectStores: m,
                        foundObjectStores: p
                    })), e();
...
const Og = pe("initial_gel_batch_timeout", 2E3),
    Pg = Math.pow(2, 16) - 1;
let Qg = !1,
    U = void 0;
class Rg {
        ...
        if (Q("jspb_with_transport_leader") && !Qg) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
            ...
            if (void 0 !== b)
                if (c) {
                    ...
                    jh(e, f, d, a);
                    Xg.delete(b)
                } else f = new Map, g = Vg.get(b) || [], f.set(b, g), hh(f, d, e, a), Vg.delete(b);
...
function fh(a = !1) {
    ...
    b = P("LOGGING_BATCH_TIMEOUT", pe("web_gel_debounce_ms", 1E4));
    ...
    if (a) {
        ...
        if (!(5 <= Uh)) {
            ...
            const G = e.message || "Unknown Error",
                Ga = e.name || "UnknownError";
            var f = e.stack || a.j || "Not available";
            if (f.startsWith(`${Ga}: ${G}`)) {
                var g = f.split("\n");
                g.shift();
                f = g.join("\n")
            }
            ...
            if ("IGNORED" === a.level) var k = 0;
                ...
                a = zh();d = b;
                for (k of a.G)
                    if (d.message && d.message.match(k.Ha)) {
                        k = k.weight;
                        break a
                    } for (var l of a.F)
                    if (l.wa(d)) {
...
function Di(a, b, c, d) {
    ...
    if (Q("il_via_jspb")) {
        ...
        D(g, 4, ce[e]);
        d && E(g, Od, 3);
        "UNDEFINED_CSN" == b ? Y("visualElementGestured", g, f) : Oh(g, f, a)
    } else e = {
        csn: b,
        ve: c.getAsJson(),
        gestureType: e
    }, d && (e.clientData = d), "UNDEFINED_CSN" == b ? Y("visualElementGestured", e, f) : a ? V("visualElementGestured", e, a, f) : W("visualElementGestured", e, f)
}
...
function Zi(a, b, c = {}) {
    c.layer || (c.layer = 0);
    var d = void 0 !== c.Ia ? c.Ia : c.layer;
    var e = X(d);
    d = qi(d);
    let f;
    ...
    let k;
    try {
        k = zi(a.client, b, f, c.na, c.cttAuthInfo, g, c.zb)
    } catch (l) {
        a = l;
        c = [{
            Lb: b,
...
function kj(a) {
    const b = {};
    var c = Ec();
    c && (b.Authorization = c, c = a = null == a ? void 0 : a.sessionIndex, void 0 === c && (c = Number(P("SESSION_INDEX", 0)), c = isNaN(c) ? 0 : c), Q("voice_search_auth_header_removal") || (b["X-Goog-AuthUser"] = c), "INNERTUBE_HOST_OVERRIDE" in le || (b["X-Origin"] = window.location.origin), void 0 === a && "DELEGATED_SESSION_ID" in le && (b["X-Goog-PageId"] = P("DELEGATED_SESSION_ID")));
    return b
}
var lj = class {
    constructor() {
...
function xj(a, b, c) {
    return r(function*() {
        ...
        if (null == b ? 0 : null == (d = b.I) ? 0 : d.context)
            for (const h of []) h.Hb(b.I.context);
        var e;
        if (null == (e = a.j) ? 0 : e.Ob(b.input, b.I)) return a.j.Bb(b.input, b.I);
        var f;
        (d = null == (f = b.config) ? void 0 : f.Kb) && a.i.has(d) && Q("web_memoize_inflight_requests") ? f = a.i.get(d) : (f = JSON.stringify(b.I), b.Y = Object.assign({}, b.Y, {
            headers: c
        ...
        d && a.i.has(d) &&
            a.i.delete(d);
        let g;
        !f && (null == (g = a.j) ? 0 : g.wb(b.input, b.I)) && (f = yield a.j.Ab(b.input, b.I));
        return f
    })
}
...
class ll {
    constructor() {
        ...
        this.l = Math.random() <= pe("ytidb_transaction_ended_event_rate_limit", .02)
    }
    V(a, b) {
        switch (a) {
